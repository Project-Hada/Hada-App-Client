...
import { Button, View, ScrollView, StyleSheet, TextInput, Pressable, Text, ImageBackground } from 'react-native';
...
export function LoginScreen({ navigation, route }: any) {
  ...
  return (
    <ImageBackground source={require('./background.png')} style={loginStyle.mainContainer}>
